...
(function($) {
	...
	/*********************************************************************************/
		...
		skel.init({
			...
			breakpoints: {
				...
				'desktop':	{ range: '641-', href: 'css/style-desktop.css', containers: 1200, grid: { gutters: 25 }, viewport: { width: 1080, scalable: false } },
    ...
    //  Custom Scripts
      ...
      $('.4u').on("mouseenter", function(event){
         var that = this
         $(this).find('.project-descriptors').animate({"bottom": "35px"}, function(){
            $(that).find('.project-description').toggleClass("hidden-description")
         })
      })

      $('.4u').on("mouseleave", function(event){
         $(this).find('.project-description').toggleClass("hidden-description")
         $(this).find('.project-descriptors').animate({"bottom": "0px"})
